//accessing all the required html elements using DOM
...
const api_key= `f2e73b79913f1b39c202cf759fb2617c`;

let api;
//using event listners to pullup the city
inputField.addEventListener("keyup", e =>{
    if(e.key == "Enter" && inputField.value != ""){
        requestApi(inputField.value);
    }
});
//using inbuilt module to get location of user
...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        //manipulating dom with fetched values
